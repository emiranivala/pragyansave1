...
- if you want bot to be running in background then enter `screen -S gagan` before `python3 -m pragyan` 
- after `python3 -m pragyan`, click `ctrl+A`, `ctrl+D`
...
Visit [Terms](https://github.com/pragyanin/Save-Restricted-Content-Bot-Repo/blob/master/TERMS_OF_USE.md) and accept the guidelines.
