...
from config import CHANNEL_USERNAME, OWNER_ID  # Changed CHANNEL_ID to CHANNEL_USERNAME
...
async def subscribe(app, message):
   update_channel = CHANNEL_USERNAME  # Replaced CHANNEL_ID with CHANNEL_USERNAME
   ...
   if update_channel:
      try:
         ...
         await message.reply_photo(photo="https://graph.org/file/4a69658ded50d47df2953-fe000d335a895f5e7d.jpg", caption=script.FORCE_MSG.format(message.from_user.mention), reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("Join Now...", url=f"{url}")]]))
         return 1
      except Exception:
