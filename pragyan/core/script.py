...
START_TXT = """
**Welcome to the Pragyan Content Saver!** Log in with /login and send a post link to start.
"""

FORCE_MSG = """
Hey {},

You've not joined the updates channel yet. If you want to use me, then join the updates channel and start me again!
"""
